...
export function Projects() {
    ...
    const getPhoneName = (id: string) => phones.find(p => p.id === id)?.name || 'Unknown';
    ...
    return (
        <div className="space-y-6">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-4 text-sm text-slate-500">
                                        ...
                                        <span className="flex items-center gap-1 text-slate-400">
                                            <Calendar className="w-3 h-3" /> {project.dateCreated}
                                        </span>
                                    </div>
                                </div>
            ...
            >
                <p className="text-slate-600">Are you sure you want to delete this project? This cannot be undone.</p>
            </Modal>
        </div>
    );
}
